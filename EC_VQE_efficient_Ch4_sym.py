...
# %%
def EC_result(N_site,n_p,E,t,w,g,k):
    """
    ...
    # Divide the system into overlapping chunks of 4 sites
    M = more_itertools.windowed(range(0,8), 4)
    a = more_itertools.windowed(range(0,N_site), 4) 
    ...
    Hn = Hmatrix(E=E,t=t,w=w,g=g,N_site=4,n_ph=n_p)
    ...
    for c in M:
        ...
        V_transformed = transformed_V(np.real(Vn),c,8,n_p)
        E_total.append(En)
    ...
    P = matp(V_tt,E=E,t=t,w=w,g=g,N_site=8,n_ph=n_p)
    ...
    l = 0
    H_hat[l:l+5,l:l+5]= H_hat4
    for i in range(int(d/L)-L):
        l+=L
        H_hat[l:l+5,l:l+5]= H_hat4_rep
...
print("The EC result is:  ", EC_result(100,2,0,1,0.1,1,1))
